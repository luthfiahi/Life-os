  ...
  return (
    <DialogPortal data-slot="dialog-portal">
      ...
      <DialogPrimitive.Content
        ...
        className={cn(
          "bg-white/95 backdrop-blur-xl data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 fixed top-[50%] left-[50%] z-50 grid w-full max-w-[calc(100%-2rem)] translate-x-[-50%] translate-y-[-50%] gap-5 rounded-2xl border border-[var(--c-border)]/50 p-6 shadow-[var(--shadow-modal)] duration-200 dark:bg-[var(--c-surface)]/95 dark:backdrop-blur-xl sm:max-w-lg",
          className
        )}
        {...props}
      >
...
function DialogFooter({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn(
        "flex flex-col-reverse gap-2 pt-4 border-t border-[var(--c-border)]/40 sm:flex-row sm:justify-end",
        className
      )}
      {...props}
    />
